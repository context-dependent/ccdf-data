...
def extract(fetch = False):
    ...
    SELECT Id, 
        ...
        Enrollment__r.Experiment_Assignment_Group__c,
    ...
    WHERE Program_Survey_ID__c IN (
        'SV_9LZgvz9zlofVICF', 'SV_bxdL3Prvkc3FRlz', 
        'SV_6i18nSYnJ64DCXb', 'SV_6Egk8lQB2hioKJn', 
        'SV_9pozdPtvvYIWbxr', 'SV_bkpwxiVSg4MsxsG',
        'SV_cYfxBbBNrr92aDI', 'SV_6JSKD9tXhIBrGrY', 
        'SV_0ptLAI6GAwPiut8', 'SV_a3gNJMpv9bh4G90', 
        'SV_23OYnv54UzcMBYG'
    )
    """
